    ...
    <>
      ...
      <div className="absolute w-[1360px] h-[270px] top-[480px] left-[280px] bg-[#8755cd4c] rounded-[40px] overflow-hidden">
        <div className="absolute w-[820px] h-[153px] top-[20px] left-[336px]">
          <p className="absolute w-[820px] h-[86px] top-[67px] left-0 [font-family:'Inter-Regular',Helvetica] font-normal text-white text-[24px] tracking-[0] leading-[34px]">
            ...
            <span className="[font-family:'Inter-Regular',Helvetica] font-normal text-white text-[24px] tracking-[0] leading-[34px]">
              {" "}
              <br />
              Check the URL carefully. Read the{" "}
            </span>
            <span className="[font-family:'Inter-Bold',Helvetica] font-bold">
              Tutorial
            </span>
          ...
          <div className="absolute w-[728px] h-[86px] top-0 left-0 [font-family:'Inter-Bold',Helvetica] font-bold text-white text-[44px] tracking-[0] leading-[28px]">
            PHISHING WARNING:
          </div>
        </div>
        <div className="absolute w-[235px] h-[60px] top-[188px] left-[336px] bg-white rounded-[50px]">
